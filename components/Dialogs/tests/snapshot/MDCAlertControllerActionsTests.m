...
- (void)addFirstLongActionWithEmphasis:(MDCActionEmphasis)emphasis {
  [self.alertController
      addAction:[MDCAlertAction actionWithTitle:kFirstLongAction emphasis:emphasis handler:nil]];
}
...
- (void)addShortActionWithEmphasis:(MDCActionEmphasis)emphasis cancelAction:(BOOL)cancelAction {
  ...
  [self.alertController
      addAction:[MDCAlertAction actionWithTitle:title emphasis:emphasis handler:nil]];
}
